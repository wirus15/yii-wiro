...
namespace wiro\components\mail;

use CApplicationComponent;
use CLogger;
use Swift_Mailer;
use Swift_Mailer_RecipientIterator;
...
class YiiMail extends CApplicationComponent
{
    ...
    */
	...
	$swiftDir = Yii::getPathOfAlias('vendor.swiftmailer.swiftmailer.lib');
	//require $swiftDir.'/classes/Swift.php';
	Yii::registerAutoloader(array('Swift','autoload'));
	require $swiftDir.'/swift_init.php';
    }
}